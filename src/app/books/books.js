...
.controller( 'BooksCtrl',function BooksController( $scope, $window, booksService, cartService, alertService, $modal, $rootScope, $timeout ) {

    //Using the book and alert services to get their respective objects.
    $scope.books = booksService.books;
    $scope.bookAlerts = alertService.alerts;

    //Adjust the number of coloums on the page 
    ...
    /*This function calculates the number of containers 
    that would be displayed on the page. It calculates it 
    by dividing the width of the page with the width of the tile itself.
    */
    ...
    //Calling calcContainers during initial page load.
    $scope.calcContainers();
})
